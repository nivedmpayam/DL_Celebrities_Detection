...
image_dir = r'C:\Users\asus\OneDrive\Desktop\deep-learning\Deep_Learning_celebrities\Dataset_Celebrities\cropped'
...
early_stop = tf.keras.callbacks.EarlyStopping(monitor='accuracy', mode='min', patience=40)

history=model.fit(x_train,y_train,epochs=30,validation_split=0.1,callbacks=[early_stop])
...
print(make_prediction(r'C:\Users\asus\OneDrive\Desktop\deep-learning\Deep_Learning_celebrities\Dataset_Celebrities\cropped\virat_kohli\virat_kohli16.png',model))
print('--------------------------------------------------------')